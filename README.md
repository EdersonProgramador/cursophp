...
CSS (Cascading Style Sheets) é uma linguagem de estilo usada para descrever a apresentação de documentos HTML, permitindo que você controle a aparência visual de uma página web.
O que é CSS?
